...
get.pckg.info("a02_mapping_data.qmd")
```
...
z <- gzcon(url("https://github.com/mgimond/spatial_appendix/raw/main/Data/elev.RDS"))
elev.r <- unwrap(readRDS(z))
z <- gzcon(url("https://github.com/mgimond/spatial_appendix/raw/main/Data/inter_sf.RDS"))
inter.sf <- readRDS(z)
z <- gzcon(url("https://github.com/mgimond/spatial_appendix/raw/main/Data/rail_sf.RDS"))
rail.sf <- readRDS(z)
z <- gzcon(url("https://github.com/mgimond/spatial_appendix/raw/main/Data/s_sf.RDS"))
s.sf <- readRDS(z)
z <- gzcon(url("https://github.com/mgimond/spatial_appendix/raw/main/Data/p_sf.RDS"))
p.sf <- readRDS(z)
```
