...
get.pckg.info("a01_Data_Manipulation.qmd")
```
...
```{r results='hide'}
download.file("https://github.com/mgimond/spatial_appendix/raw/main/Data/Income_schooling.zip", 
...
```{r}
download.file("https://github.com/mgimond/spatial_appendix/raw/main/Data/rail_inters.gpkg", 
              destfile = "./rail_inters.gpkg", mode='wb')
```

```{r}
download.file("https://github.com/mgimond/spatial_appendix/raw/main/Data/elev.img",  
